...
const ImmersiveVisualizer = ({
    ...
    const narrationTimeoutRef = useRef(null); // Track narration timeout to prevent double triggers
    ...
    const moveToNextStep = useCallback(() => {
        ...
        currentNarrationStepRef.current = -1; // Signal any running narration to stop
            ...
            <header className="flex-shrink-0 flex items-center justify-between px-6 py-4 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-medium transition-all ${isGuidedMode
                        ...
                        <div className="flex items-center gap-2 bg-slate-800 rounded-xl px-3 py-1.5">
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-2 py-0.5 text-xs rounded-lg transition-all ${playbackSpeed === value
                    ...
                    <button
                        ...
                        className={`p-3 rounded-xl transition-all ${isStreaming
